...
5. we think we know what other people are thinking
	...
	- [[#Spotlight effect, Streetlight effect]]
...
### Barnum effect
### Base rate fallacy
def: ignoring general background info (base rate) and focusing only on specific case information
-> e.g. assume quiet, introverted person must be a librarian vs. salesperson, ignoring the base rate fact N_salesperson >>> N_librarian 
