...
2. creativity begins with copying (wink 🔗 [[steal like an artist]])
3. success is the best teacher (??)
4. knowledge becomes invisible with experience (becomes second nature)
5. difficulty has a sweet spot (fine-tune to maximise growth)
6. the mind is not a muscle (???)
7. variability >>> repetition
8. quality comes from quality (wink 🔗 [[art and fear]]) 
...
one technique to bridge the gap between experts and learners: [cognitive task analysis (CTA)](https://www.globalcognition.org/cognitive-task-analysis/)
...
1. progressively increase complexity
2. use variability in practice
3. seek feedback to calibrate challenge level
...
1. shuffle your studying
   -> mix and match topics and skills to gain breadth 
2. get exposed to diverse performers and examples
   -> enrich perspectives and techniques 
3. learn the theories and develop multiple representations of knowledge
   -> deeper understanding of underlying principles to enhance knowledge application 
4. practice in changing contexts
	-> avoid context-specific learning 
5. get it right first, then vary your practice
