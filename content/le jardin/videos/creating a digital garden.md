---
title: creating a digital garden to end my doomscrolling
draft: false
tags:
created: 2025-04-08
...
How? 
- having a `system` that supports that -> `taking notes SMART!`
	- => one way to do it is with a ***digital garden***
...
## Digital garden 101
#### Quick definition
- **DEF**: a digital garden is a place that makes it possible to 
...
- WHAT IT **IS**: you can write about *any topic* and you can *connect* it to all of the other things that have to do with that topic or have to do with ==something adjacent== to it and you can see the ways that all of your ==interests are interconnected==
...
1. Be `aware`
2. Break yourself out of that `pattern`
3. Become a `better consumer`: 
...
- You take time to *think* about those notes. SLOW DOWN. *PAUSE*.
	- -> you `reflect` on the notes, agree, disagree, etc. 
	- -> you invite your thought process into the conversation.
...
1. Topography over timeline: contextual relationship -> wikipedia
	1. links, concepts, themes
	2. vs. chronological, journal, blog
2. Continuous growth 
	1. it's scrappy, it's always a bit drafty
	2. vs. not carefully crafted, done, final version, essays, blogs 
3. Imperfection and Learning in public
4. Playful, personal, experimental 
	1. vs. homogeneous
	2. -> it's your own arrangement even if we all consume the same input, the output and the execution, the style, everything is your own doing! -> this is why you add you own voice and interpretation
5. Intercropping and Content Diversity 
	1. allow exploration of complex ideas with various mediums (pics, texts, videos, codes, movies...)
	2. vs. chronological, fixed 
6. Independent Ownership 
	1. = claiming a small patch of the internet 
